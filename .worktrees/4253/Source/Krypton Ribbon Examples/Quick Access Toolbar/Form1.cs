...
public partial class Form1 : KryptonForm
{
    ...
    public Form1()
    {
        ...
        // Issue #4253: overflow chevrons use per-theme metrics and scale with DPI.
        var dpiNote = new KryptonWrapLabel
        {
            Dock = System.Windows.Forms.DockStyle.Bottom,
            LabelStyle = LabelStyle.NormalPanel,
            Text = "Issue #4253: add enough QAT buttons to show the overflow extra button, then switch Office 2007 "
                 + "versus Office 2010 (or OSX Aqua / macOS) and re-open at 100%, 150% and 200% DPI. Chevrons should "
                 + "stay inside the extra button; Office 2010 family uses a unified colour."
        };
        panelFill.Controls.Add(dpiNote);
        dpiNote.BringToFront();
    }
