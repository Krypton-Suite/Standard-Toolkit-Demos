...
namespace KryptonBindingNavigatorExample
{
    public partial class Form1 : KryptonForm
    {
        ...
        private void InitializeData()
        {
            ...
            _bindingSource = new BindingSource { DataSource = _dataList, AllowNew = true };
            ...
            ktxtFirstName.DataBindings.Add("Text", _bindingSource, "FirstName", false,
                DataSourceUpdateMode.OnPropertyChanged);
            ktxtLastName.DataBindings.Add("Text", _bindingSource, "LastName", false,
                DataSourceUpdateMode.OnPropertyChanged);
