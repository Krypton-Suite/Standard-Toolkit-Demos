...
* [Toolkit Examples](#toolkit-examples)
	...
	* [KryptonToggleSwitch](#kryptontoggleswitch)]
...
## KryptonDataGridView
![KryptonDataGridView Examples](KryptonDataGridView%20Examples/example.gif)
...
`AcrylicValues` on the form (and the **Acrylic title bar and borders (#1273)** checkbox) applies optional DWM acrylic to the caption and borders. Drag the window over a colourful background, switch palettes, and edit `AcrylicValues` in the property grid.
## KryptonFormFading
...
![KryptonTableLayoutPanel Examples](KryptonTableLayoutPanel%20Examples/example.png)
## KryptonTaskDialog
