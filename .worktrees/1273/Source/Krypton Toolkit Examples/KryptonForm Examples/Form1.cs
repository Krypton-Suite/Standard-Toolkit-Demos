...
public partial class Form1 : KryptonForm
{
    ...
    private void Form1_Load(object sender, EventArgs e)
    {
        ...
        var chkAcrylic = new KryptonCheckBox
        {
            AutoSize = true,
            Location = new Point(3, 380),
            Name = "chkAcrylicChrome",
            Text = @"Acrylic title bar and borders (#1273)"
        };
        chkAcrylic.CheckedChanged += (_, _) =>
        {
            AcrylicValues.EnableAcrylic = chkAcrylic.Checked;
            AcrylicValues.Opacity = 70;
            AcrylicValues.ApplyTo = AcrylicApplyTo.TitleBarAndBorders;
        };
        kryptonHeaderGroup2.Panel.Controls.Add(chkAcrylic);
    }
...
public class KryptonFormProxy
{
    ...
    [Category("Visuals")]
    [Description("Acrylic title bar and form border composition (#1273).")]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
    public AcrylicValues AcrylicValues => _form.AcrylicValues;
