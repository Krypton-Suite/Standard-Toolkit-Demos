...
public partial class Form1 : KryptonForm
{
    ...
    private readonly List<object> _richSuggestions = new List<object>();
    ...
    private void InitializeSearchBoxes()
    {
        ...
        // Handle events
        ksbBasicSearchWithHistory.TextChanged += KsbBasicSearchWithHistory_TextChanged;
        ksbBasicSearchWithHistory.Search += KsbBasicSearchWithHistory_Search;
        ksbBasicSearchWithHistory.SearchCleared += KsbBasicSearchWithHistory_SearchCleared;
        ksbBasicSearchWithHistory.SuggestionSelected += KsbBasicSearchWithHistory_SuggestionSelected;
        ...
        ksbDataGridViewWithHighlighting.TextChanged += KsbDataGridViewWithHighlighting_TextChanged;
        ksbDataGridViewWithHighlighting.Search += KsbDataGridViewWithHighlighting_Search;
        ksbDataGridViewWithHighlighting.SearchCleared += KsbDataGridViewWithHighlighting_SearchCleared;
        ...
        ksbRichSuggestionsWithIcons.SuggestionSelected += KsbRichSuggestionsWithIcons_SuggestionSelected;
        ...
        ksbDataGridViewWithMultipleColumns.SuggestionSelected += KsbDataGridViewWithMultipleColumns_SuggestionSelected;
        ...
        ksbCustomFiltering.SuggestionSelected += KsbCustomFiltering_SuggestionSelected;
    }
    ...
    private void KsbCustomFiltering_SuggestionSelected(object? sender, SuggestionSelectedEventArgs e) =>
            // Handle custom filter suggestion selection
            klblCustomFilterResults.Text = $"Custom filter: {e.Suggestion ?? ksbCustomFiltering.Text}";

    private void KsbDataGridViewWithMultipleColumns_SuggestionSelected(object? sender, SuggestionSelectedEventArgs e)
    {
    ...
    private void KsbRichSuggestionsWithIcons_SuggestionSelected(object? sender, SuggestionSelectedEventArgs e)
    {
    ...
    private void KsbDataGridViewWithHighlighting_SearchCleared(object? sender, EventArgs e)
    {
    ...
    private void KsbDataGridViewWithHighlighting_Search(object? sender, SearchEventArgs e)
    {
    ...
    private void KsbDataGridViewWithHighlighting_TextChanged(object? sender, EventArgs e) =>
            // Real-time highlighting in DataGridView as user types
            HighlightDataGridView(ksbDataGridViewWithHighlighting.Text);
    private void KsbBasicSearchWithHistory_SuggestionSelected(object? sender, SuggestionSelectedEventArgs e)
    {
    ...
    private void KsbBasicSearchWithHistory_SearchCleared(object? sender, EventArgs e)
    {
    ...
    private void KsbBasicSearchWithHistory_Search(object? sender, SearchEventArgs e)
    {
        ...
        klblFoundItems.Text = !string.IsNullOrEmpty(e.SearchText) ? $"Found {klbFruits.Items.Count} matching items" : "Showing all items";
    }

    private void KsbBasicSearchWithHistory_TextChanged(object? sender, EventArgs e) => FilterListBox(ksbBasicSearchWithHistory.Text);
}