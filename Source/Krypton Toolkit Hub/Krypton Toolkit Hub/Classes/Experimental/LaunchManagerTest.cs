            ...
            switch (componentExample)
            {
                case ComponentToolkitExamples.KRYPTONBUTTON:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Button Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONCHECKBUTTON:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton CheckButton Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONDROPBUTTON:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton DropButton Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONCOLOURBUTTON:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton ColorButton Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONCHECKSET:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton CheckSet Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONCHECKBOX:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton CheckBox Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONRADIOBUTTON:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton RadioButton Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONLABEL:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Label Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONLINKLABEL:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Link Label Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONWRAPLABEL:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Wrap Label Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONSPLITCONTAINER:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Split Container Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONCONTEXTMENU:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Context Menu Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONTRACKBAR:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton TrackBar Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONLISTBOX:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton ListBox Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONCHECKEDLISTBOX:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Checked ListBox Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONTEXTBOX:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton TextBox Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONMASKEDTEXTBOX:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Masked TextBox Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONRICHTEXTBOX:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Rich TextBox Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONCOMBOBOX:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton ComboBox Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONNUMERICUPDOWN:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Numeric UpDown Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONDOMAINUPDOWN:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Domain UpDown Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONBREADCRUMB:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Bread Crumb Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONDATETIMEPICKER:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton DateTimePicker Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONMONTHCALENDAR:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Month Calendar Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONDATAGRIDVIEW:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Data GridView Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONTREEVIEW:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton TreeView Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONBORDEREDGE:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Border Edge Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONSEPARATOR:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Separator Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONPANEL:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Panel Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONGROUP:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Group Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONGROUPBOX:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton GroupBox Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONHEADERGROUP:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Header Group Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONHEADER:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Header Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONPALETTE:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Palette Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONCOMMAND:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Command Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONINPUTBOX:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton InputBox Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONMESSAGEBOX:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton MessageBox Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONTASKDIALOG:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton TaskDialog Examples.exe",
                        useFullPath);
                ...
                case ComponentToolkitExamples.KRYPTONFORM:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Form Examples.exe",
                        useFullPath);
            ...
            ToolStripLabel statusLabel = null, string statusText = null, bool useFullPath = false)
        {
            switch (applicationExample)
            {
                case ApplicationToolkitExamples.INPUTFORM:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Input Form Examples.exe", useFullPath);
                ...
                case ApplicationToolkitExamples.THREEPANEAPPLICATIONBASIC:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Three Pane Application Basic.exe",
                        useFullPath);
                ...
                case ApplicationToolkitExamples.THREEPANEAPPLICATIONEXTENDED:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Three Pane Application Extended.exe",
                        useFullPath);
                ...
                case ApplicationToolkitExamples.EXPANDINGHEADERGROUPSSPLITTERS:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() +
                        "\\Expanding Header Groups Splitters Examples.exe", useFullPath);
                ...
                case ApplicationToolkitExamples.EXPANDINGHEADERGROUPSDOCKSTYLE:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() +
                        "\\Expanding Header Groups DockStyle Examples.exe", useFullPath);
                ...
                case ApplicationToolkitExamples.EXPANDINGHEADERGROUPSSTACK:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() +
                        "\\Expanding Header Groups Stack Examples.exe", useFullPath);
                ...
                case ApplicationToolkitExamples.MDIAPPLICATION:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\MDI Application.exe", useFullPath);
                ...
                case ApplicationToolkitExamples.CHILDCONTROLSTACK:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Child Control Stack.exe", useFullPath);
                ...
                case ApplicationToolkitExamples.BUTTONSPECPLAYGROUND:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Button Spec Playground.exe",
                        useFullPath);
                ...
                case ApplicationToolkitExamples.CUSTOMCONTROLUSINGPALETTES:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Custom Control Using Palettes.exe",
                        useFullPath);
                ...
                case ApplicationToolkitExamples.CUSTOMCONTROLUSINGRENDERERS:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Custom Control Using Renderers.exe",
                        useFullPath);
            ...
            ToolStripLabel statusLabel = null, string statusText = null, bool useFullPath = false)
        {
            switch (applicationToolkitExample)
            {
                ...
                case TestApplicationToolkitExamples.SYSTEMTHEMEDFORMS:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\System Themed Forms.exe", useFullPath);
                ...
                case TestApplicationToolkitExamples.TESTCLIPBASE:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Test Clip Base.exe", useFullPath);
                ...
                case TestApplicationToolkitExamples.TESTMESSAGEBOXCLIPPING:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Test MessageBox Clipping.exe",
                        useFullPath);
                ...
                case TestApplicationToolkitExamples.TESTTEXTCLIPPING:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Test Text Clipping.exe", useFullPath);
            ...
            ToolStripLabel statusLabel = null, string statusText = null, bool useFullPath = false)
        {
            switch (dockingFeatureExample)
            {
                case DockingFeatureExamples.DOCKINGCUSTOMISED:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Docking Customized.exe", useFullPath);
                ...
                case DockingFeatureExamples.DOCKINGPERSISTENCE:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Docking Persistence.exe", useFullPath);
                ...
                case DockingFeatureExamples.DOCKINGFLAGS:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Docking Flags.exe", useFullPath);
                ...
                case DockingFeatureExamples.MULTICONTROLDOCKING:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Multi Control Docking.exe",
                        useFullPath);
                ...
                case DockingFeatureExamples.EXTERNALDRAGTODOCKING:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\External Drag To Docking.exe",
                        useFullPath);
            ...
            ToolStripLabel statusLabel = null, string statusText = null, bool useFullPath = false)
        {
            switch (dockingUsageExample)
            {
                case DockingUsageExamples.STANDARDDOCKING:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Standard Docking.exe", useFullPath);
                ...
                case DockingUsageExamples.NAVICATORPLUSFLOATINGWINDOWS:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Navigator And Floating Windows.exe",
                        useFullPath);
            ...
            ToolStripLabel statusLabel = null, string statusText = null, bool useFullPath = false)
        {
            switch (workspaceFeatureExample)
            {
                case WorkspaceFeatureExamples.WORKSPACECELLMODES:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Workspace Cell Modes.exe", useFullPath);
                ...
                case WorkspaceFeatureExamples.WORKSPACECELLLAYOUT:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Workspace Cell Layout.exe",
                        useFullPath);
                ...
                case WorkspaceFeatureExamples.WORKSPACEPERSISTENCE:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Workspace Persistence.exe",
                        useFullPath);
                ...
                case WorkspaceFeatureExamples.CELLMAXIMISEPLUSRESTORE:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Cell Maximize And Restore.exe",
                        useFullPath);
                ...
                case WorkspaceFeatureExamples.BASICPAGEDRAGANDDROP:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Basic Page Drag And Drop.exe",
                        useFullPath);
                ...
                case WorkspaceFeatureExamples.ADVANCEDPAGEDRAGANDDROP:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Advanced Page Drag And Drop.exe",
                        useFullPath);
            ...
            ToolStripLabel statusLabel = null, string statusText = null, bool useFullPath = false)
        {
            switch (workspaceUsageExample)
            {
                case WorkspaceUsageExamples.RIBBONPLUSNAVIGATORPLUSWORKSPACE:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Ribbon And Navigator And Workspace.exe",
                        useFullPath);
                ...
                case WorkspaceUsageExamples.MEMOEDITOR:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Memo Editor.exe", useFullPath);
            ...
            ToolStripLabel statusLabel = null, string statusText = null, bool useFullPath = false)
        {
            switch (navigatorFeatureExample)
            {
                case NavigatorFeatureExamples.NAVIGATORMODES:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Navigator Modes.exe", useFullPath);
                ...
                case NavigatorFeatureExamples.NAVIGATORPALETTES:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Navigator Palettes.exe", useFullPath);
                ...
                case NavigatorFeatureExamples.OREINTATIONPLUSALIGNMENT:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Orientation Plus Alignment.exe",
                        useFullPath);
                ...
                case NavigatorFeatureExamples.SINGLELINEPLUSMULTILINE:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Singleline Plus Multiline.exe",
                        useFullPath);
                ...
                case NavigatorFeatureExamples.TABBORDERSTYLES:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Tab Border Styles.exe", useFullPath);
                ...
                case NavigatorFeatureExamples.POPUPPAGES:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Popup Pages.exe", useFullPath);
                ...
                case NavigatorFeatureExamples.PERTABBUTTONS:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Per Tab Buttons.exe", useFullPath);
                ...
                case NavigatorFeatureExamples.NAVIGATORTOOLTIPS:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Navigator Tool Tips.exe", useFullPath);
                ...
                case NavigatorFeatureExamples.NAVIGATORCONTEXTMENUS:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Navigator Context Menus.exe",
                        useFullPath);
                ...
                case NavigatorFeatureExamples.NAVIGATORPLAYGROROUND:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Navigator Playground.exe", useFullPath);
                ...
                case NavigatorFeatureExamples.BASICEVENTS:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Basic Events.exe", useFullPath);
            ...
            ToolStripLabel statusLabel = null, string statusText = null, bool useFullPath = false)
        {
            switch (navigatorUsageExample)
            {
                case NavigatorUsageExamples.USERPAGECREATION:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\User Page Creation.exe", useFullPath);
                ...
                case NavigatorUsageExamples.ONENOTETABS:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\OneNote Tabs.exe", useFullPath);
                ...
                case NavigatorUsageExamples.OUTLOOKMOCKUP:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Outlook Mockup.exe", useFullPath);
                ...
                case NavigatorUsageExamples.EXPANDINGPAGES:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Expanding Pages.exe", useFullPath);
            ...
            ToolStripLabel statusLabel = null, string statusText = null, bool useFullPath = false)
        {
            switch (ribbonFeatureExample)
            {
                case RibbonFeatureExamples.CONTEXTUALTABS:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Contextual Tabs.exe", useFullPath);
                ...
                case RibbonFeatureExamples.KEYTIPSPLUSKEYBOARDACCESS:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Key Tips And Keyboard Access.exe",
                        useFullPath);
                ...
                case RibbonFeatureExamples.AUTOSHRINKINGGROUPS:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Auto Shrinking Groups.exe",
                        useFullPath);
                ...
                case RibbonFeatureExamples.QUICKACCESSTOOLBAR:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Quick Access Toolbar.exe", useFullPath);
                ...
                case RibbonFeatureExamples.RIBBONGALLERY:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Ribbon Gallery.exe", useFullPath);
                ...
                case RibbonFeatureExamples.RIBBONTOOLTIPS:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Ribbon Tool Tips.exe", useFullPath);
                ...
                case RibbonFeatureExamples.RIBBONCONTROLS:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Ribbon Controls.exe", useFullPath);
                ...
                case RibbonFeatureExamples.APPLICATIONMENU:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Application Menu.exe", useFullPath);
                ...
                case RibbonFeatureExamples.KRYPTONGALLERYEXAMPLES:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Krypton Gallery Examples.exe",
                        useFullPath);
            ...
            ToolStripLabel statusLabel = null, string statusText = null, bool useFullPath = false)
        {
            switch (ribbonUsageExample)
            {
                case RibbonUsageExamples.OUTLOOKMAILCLONE:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Outlook Mail Clone.exe", useFullPath);
                ...
                case RibbonUsageExamples.MDIRIBBON:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\MDI Ribbon.exe", useFullPath);
            ...
            ToolStripLabel statusLabel = null, string statusText = null, bool useFullPath = false)
        {
            switch (kryptonApplication)
            {
                case KryptonApplications.PALETTEDESIGNER:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Palette Designer.exe", useFullPath);
                ...
                case KryptonApplications.PALETTEUPGRADETOOL:
                    ProcessManager.LaunchProcess(
                        IOOperations.GetApplicationProcessExecutablePath() + "\\Palette Upgrade Tool.exe", useFullPath);
