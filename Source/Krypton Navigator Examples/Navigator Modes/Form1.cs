    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            _lookup = new DescriptionLookup
            {
                ...
                { NavigatorMode.BarRibbonTabGroup, "BarRibbonTabGroup shows a set of ribbon styled tabs on the outside of a Group container.\n\n" +
                                                   "The contents of the selected page are displayed inside the Group container whilst the tab bar has a Panel style background.\n\n" +
                                                   "Buttons are provided on the right hand side of the bar so the user can change the selected page or remove a page from the control. " +
                                                   "As with all bar modes, you can change the edge the bar is orientated against." },
                { NavigatorMode.BarRibbonTabOnly, "BarRibbonTabOnly is a tab strip style mode that does not display the contents of the selected page.\n\n" +
                                                  "It shows a set of ribbon styled tabs that allow the user to select different pages at random.\n\n" +
                                                  "This mode is useful when you want to provide your own separate mechanism for displaying the selected item. " +
                                                  "By setting the AutoSize=True property on the navigator you can get the control to size appropriately." },
                { NavigatorMode.BarCheckButtonGroupOutside, "BarCheckButtonGroupOutside shows a bar of CheckButton controls on the outside of a Group container.\n\n" +
                ...
                { NavigatorMode.BarCheckButtonGroupInside, "BarCheckButtonGroupInside shows a Group container that has two items inside.\n\n" +
                                                           ...
                                                           "Buttons are provided on the right hand side of the bar so the user can change the selected page or remove a page from the control.\n\n" +
                                                           "As with all bar modes, you can change the edge the bar is orientated against." },
                { NavigatorMode.BarCheckButtonGroupOnly, "BarCheckButtonGroupOnly is a tab strip style mode that does not display the contents of the selected page.\n\n" +
                                                         "It shows a Group style container that has a bar of CheckButton controls inside.\n\n" +
                                                         "This mode is useful when you want to provide your own separate mechanism for displaying the selected item. " +
                                                         "By setting the AutoSize=True property on the navigator you can get the control to size appropriately." },
                { NavigatorMode.BarCheckButtonOnly, "BarCheckButtonOnly is a tab strip style mode that does not display the contents of the selected page.\n\n" +
                                                    ...
                                                    "This mode is useful when you want to provide your own separate mechanism for displaying the selected item. " +
                                                    "By setting the AutoSize=True property on the navigator you can get the control to size appropriately." },
                { NavigatorMode.HeaderBarCheckButtonGroup, "HeaderBarCheckButtonGroup shows a Header bar containing CheckButton controls within a Group container.\n\n" +
                                                           "The contents of the selected page are displayed inside the Group container.\n\n" +
                                                           "Buttons are provided on the right hand side of the bar so the user can change the selected page or remove a page from the control. " +
                                                           "As with all modes that show buttons, you can customize the buttons that appear and how they function." },
                { NavigatorMode.HeaderBarCheckButtonHeaderGroup, "HeaderBarCheckButtonHeaderGroup mode provides a Header containing CheckButton controls and two additional headers for displaying information about the currently selected page.\n\n" +
                ...
                { NavigatorMode.HeaderBarCheckButtonOnly, "HeaderBarCheckButtonOnly is a tab strip style mode that does not display the contents of the selected page.\n\n" +
                ...
                { NavigatorMode.StackCheckButtonHeaderGroup, "StackCheckButtonGroup mode shows a set of CheckButton controls in conjunction with two headers for displaying information about the currently selected page.\n\n" +
                                                             "You can choose to stack in either a vertical or horizontal orientation. " +
                                                             "The selected page is shown immediately below the matching CheckButton but you can choose to have all the CheckButtons placed at the top or bottom." },
                { NavigatorMode.OutlookFull, "OutlookFull mode mimics the expanded operation of the Microsoft Outlook 2007 selection control.\n\n" +
                ...
                { NavigatorMode.OutlookMini, "OutlookMini mode mimics the collapsed operation of the Microsoft Outlook 2007 selection control.\n\n" +
                ...
                { NavigatorMode.HeaderGroup, "HeaderGroup mode provides two headers that are used to display information about the currently selected page.\n\n" +
                                             "Buttons are provided on the primary header so the user can page the selected page or remove a page from the control.\n\n" +
                                             "You can customize how page details are mapped to the headers in order to show only the exact details you need in the location of your choice." },
                { NavigatorMode.HeaderGroupTab, "HeaderGroupTab mode provides two headers that are used to display information about the currently selected page along with a set of tabs for page selection.\n\n" +
                                                "Buttons are provided on the primary header so the user can page the selected page or remove a page from the control.\n\n" +
                                                "You can customize how page details are mapped to the headers in order to show only the exact details you need in the location of your choice." },
        ...
        {
            var mode = NavigatorMode.BarTabGroup;
