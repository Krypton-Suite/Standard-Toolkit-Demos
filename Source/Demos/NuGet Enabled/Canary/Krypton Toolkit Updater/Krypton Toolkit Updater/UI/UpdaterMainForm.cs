...
namespace KryptonToolkitUpdater.UI
{
    public partial class UpdaterMainForm : KryptonForm
    {
        ...
        {
            CheckForUpdates("https://github.com/Wagnerp/Krypton-Toolkit-Suite-NET-Core0/blob/master/Updates/update.xml");
        }
        ...
        {
            KryptonMessageBox.Show("This utility will enable you to check for and download updates for Krypton .NET 5.500.", "Help", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
