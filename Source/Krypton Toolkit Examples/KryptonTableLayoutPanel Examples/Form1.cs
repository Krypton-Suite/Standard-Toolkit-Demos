...
namespace KryptonTableLayoutPanelExamples
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e) =>
            ...
            propertyGrid.SelectedObject = new KryptonPanelProxy(panel2Office);
    ...
    {
        private KryptonTableLayoutPanel _panel;

        public KryptonPanelProxy(KryptonTableLayoutPanel panel) => _panel = panel;
