...
namespace KryptonPropertyGridExample
{
    public partial class Form1 : Form
    {
        ...
        private void SetSelectedObject(object obj) => kryptonPropertyGrid1.SelectedObject = obj;
        ...
        private void kryptonCheckedListBox1_Click(object sender, EventArgs e)
        {
            SetSelectedObject(kryptonCheckedListBox1);
        }

        private void kryptonDateTimePicker1_Click(object sender, EventArgs e)
        {
