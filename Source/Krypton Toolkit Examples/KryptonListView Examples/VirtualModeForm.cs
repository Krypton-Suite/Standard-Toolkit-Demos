...
/// <summary>
/// Consumer demo for KryptonListView virtual mode (#3847).
/// </summary>
public partial class VirtualModeForm : KryptonForm
{
    ...
    private void BindVirtualList(ListView listView)
    {
        ...
        listView.VirtualItemsSelectionRangeChanged += OnSelectionChanged;
    ...
    private void OnSelectionChanged(object? sender, EventArgs e) => UpdateStatus();
    ...
    private void UpdateStatus(string? extra = null)
    {
        ...
        var message =
            ...
            $"selected native={lvNative.SelectedIndices.Count}, krypton={klvKrypton.SelectedIndices.Count}.";
