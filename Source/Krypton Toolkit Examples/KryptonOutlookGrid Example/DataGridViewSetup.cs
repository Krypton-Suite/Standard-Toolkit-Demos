...
namespace KryptonOutlookGrid
{
    public class DataGridViewSetup
    {
        ...
        public void SetupDataGridView(Krypton.Toolkit.KryptonOutlookGrid grid, bool restoreIfPossible)
        {
        ...
        /// </summary>
        /// <param name="grid">The grid.</param>
        private void LoadDefaultConfiguration(Krypton.Toolkit.KryptonOutlookGrid grid)
        {
            grid.ClearEverything();
        ...
        /// <param name="grid">The grid.</param>
        private void LoadConfigFromFile(string file, Krypton.Toolkit.KryptonOutlookGrid grid)
        {
        ...
        private void CheckAndUpgradeConfigFile(int versionGrid, XDocument doc, Krypton.Toolkit.KryptonOutlookGrid grid, LoadState state)
        {
        ...
        /// <param name="grid">The grid.</param>
        /// <param name="state">The state.</param>
        private void UpgradeGridConfigToVx(XDocument doc, int version, Krypton.Toolkit.KryptonOutlookGrid grid, LoadState state)
        {
