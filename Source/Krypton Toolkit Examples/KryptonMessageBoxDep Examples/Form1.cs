...
";
        ...
        private void kbtnShow_Click(object sender, EventArgs e)
        {
            ...
            DialogResult res = KryptonMessageBoxDep.Show(this, textBoxMessage.Text, textBoxCaption.Text,
                _mbButtons,
                _kmbIcon,
                options: _options,
        ...
        private void Form1_HelpRequested(object sender, HelpEventArgs hlpEvent)
        {
            ...
            var helpLabel = new Label {
                Dock = DockStyle.Fill,
                Text =
                    $@"Help information shown in response to user action on the '{(string?)senderControl?.Tag}' message."
            };
